...
import { removeFavoriteMovie, addFavoriteMovie } from '~/services/favoriteService';
...
function MovieFavorite({ image, title, duration, category, to , viewNumber, movieId}) {
    ...
    function handleFavoriteClick() {
        ...
        if (isFavorite) {
            ...
            setIsFavorite(true)
            addFavoriteMovie(user.id, movieId);
          }
    }
    return (
                ...
                <div className='flex items-center'>
                    ...
                    <div className={`flex items-center ml-2 cursor-pointer `}
                        >
                           ...
                           <svg xmlns="http://www.w3.org/2000/svg" onClick={handleFavoriteClick} viewBox="0 0 24 24" fill="currentColor" className={`h-6 w-6 text-red-500 ${
